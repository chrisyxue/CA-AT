...
def trades_loss(model, x_natural, y, optimizer, step_size=0.003, epsilon=0.031, perturb_steps=10, 
                attack='linf-pgd'):
    """
    ...
    loss = loss_robust
    batch_metrics = {'adv_loss': loss.item(), 'adv_acc': accuracy(y, logits_adv.detach())}
