...
def parser_train():
    ...
    """
    Parse for Adversarial PEFT 
    """
    parser.add_argument('--use_adver_peft',action='store_true',help='Use Adversarial PEFT or not')
    parser.add_argument('--adver_peft_type',default='LoRA',choices=['LoRA'],help='The type of Adversarial PEFT')
    parser.add_argument('--adver_peft_model',default='ViT-B',choices=['ViT-B'],help='The Model for Adversarial PEFT')
