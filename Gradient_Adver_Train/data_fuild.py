...
# results from differnt layers
name_list = ['origin','fm1','fm2','fm3','fm4','fm5']
...
class Dataset_Adver(data.Dataset):
  'Characterizes a dataset for PyTorch'
  def __init__(self, path='/localscratch2/xuezhiyu/Adver_Data_Vis/cifar10/ResNet34'):
        'Initialization'
        self.path = path
