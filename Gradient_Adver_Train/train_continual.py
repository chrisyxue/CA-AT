...
if args.from_scratch:
    save_folder = os.path.join('/localscratch2/xuezhiyu/Adver_Continual_Scratch', args.dataset, 'Task_Num_'+str(args.task_num), model_str, '%s_%s' % (attack_str, loss_str))
else:
    save_folder = os.path.join('/localscratch2/xuezhiyu/Adver_Continual', args.dataset, 'Task_Num_'+str(args.task_num),model_str, '%s_%s' % (attack_str, loss_str))
