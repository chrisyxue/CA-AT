...
if 'res' in args.model:
    model = resnet(args.model)
elif 'WRN' in args.model:
    model = wideresnet(args.model)
else:
...
# use pretraining
if args.use_pretrain is True:
    pretrain_file = '/localscratch2/xuezhiyu/Gradient_Adver_Train/cifar10/ResNet34/untargeted-pgd-8-7_e200-b256_sgd-lr0.1-m0.9-wd0.0005_cos_lambda0.0/latest.pth'
