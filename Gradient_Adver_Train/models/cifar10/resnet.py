...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, mid_planes, out_planes, stride=1):
        ...
        self.bn1 = nn.BatchNorm2d(mid_planes,track_running_stats=False,affine=True)
        # self.bn1 = nn.BatchNorm2d(mid_planes)
        self.conv2 = nn.Conv2d(mid_planes, out_planes, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(out_planes,track_running_stats=False,affine=True)
        ...
        if stride != 1 or in_planes != out_planes:
            self.shortcut = nn.Sequential(
                ...
                nn.BatchNorm2d(out_planes,track_running_stats=False,affine=True)
            )
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.bn1 = nn.BatchNorm2d(64,track_running_stats=False,affine=True)
...
def ResNet34_ENC():
    ...
    GFLOPS: 1.1635, model size: 21.2859MB
    '''
    return ResNet_ENC(BasicBlock, [3,4,6,3])
