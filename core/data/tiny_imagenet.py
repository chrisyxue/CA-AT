...
def load_tinyimagenet(args, data_dir, use_augmentation=False):
    """
    ...
    train_dataset = TinyImageNet(data_dir, split='train', download=True, transform=train_transform)
    test_dataset = TinyImageNet(data_dir, split='val', download=False, transform=test_transform)
