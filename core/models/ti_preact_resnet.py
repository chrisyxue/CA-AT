...
class PreActBottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn3 = nn.BatchNorm2d(planes,track_running_stats=False,affine=True)
...
class PreActResNet(nn.Module):
    ...
    """
    def __init__(self, block, num_blocks, num_classes=200, classifier='linear'):
        ...
        self.bn = nn.BatchNorm2d(512 * block.expansion,track_running_stats=False,affine=True)
